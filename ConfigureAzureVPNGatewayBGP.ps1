...
#Create the local network gateway for Site5
...
#Create the TestVNet1 to Site5 connection
New-AzVirtualNetworkGatewayConnection -Name $Connection15 -ResourceGroupName $RG1 -VirtualNetworkGateway1 $vnet1gw -LocalNetworkGateway2 $lng5gw -Location $Location1 -ConnectionType IPsec -SharedKey 'AzureA1b2C3' -EnableBGP $True

<#Example parameters to enter in On-premises VPN device:
- Site5 ASN            : 65050
...
#Create TestVNet2 in the new resource group
...
#Create the VPN gateway for TestVNet2 with BGP parameters
...
#Create the new VPN with the AS number:
